...
#### Arguments
  ...
  - `config` (_Object_) : The configuration object for the async Component. It has the following properties available:
    ...
    - `throwError` (_Boolean_, Options, default: `false`) : If there is an error, throw it on render. This is useful for error boundaries and throwing errors up the tree.
